...
class Claim < ApplicationRecord
  ...
  validates :first_name, on: [:"personal-details", :submit], length: {in: 3..30, message: "First name must be between 3 and 30 characters"}
  ...
  validates :surname, on: [:"personal-details", :submit], length: {in: 3..30, message: "Last name must be between 3 and 30 characters"}
